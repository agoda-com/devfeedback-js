...
import { getCommonMetadata, sendBuildData } from 'agoda-devfeedback-common/common';
import type { WebpackBuildData, DevFeedbackEvent } from 'agoda-devfeedback-common/types';
